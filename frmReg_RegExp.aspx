...
<body>
    <form id="form1" runat="server" style="border-style: solid; border-width: medium; border-color: inherit; margin-top: 100px; margin-left: 350px; color: #009900; height: 429px;">   
...
&nbsp;&nbsp;&nbsp;
        <asp:Panel ID="Panel2" runat="server" Height="395px" Width="489px">
            <br />
            &nbsp;
            ...
            <br />
            &nbsp;
            <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="#009933" Text="Contact No. :"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtContact" runat="server" Width="223px"></asp:TextBox>
&nbsp;&nbsp;<br /><br />&nbsp;
            <asp:Label ID="Label8" runat="server" Font-Bold="True" ForeColor="#009933" Text="Email-Id :"></asp:Label>
